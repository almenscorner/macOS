...
weburl="YOUR URL"      # What is the Azure Blob Storage URL?
appname="MunkiReport"                                                                              # The name of our App deployment script (also used for Octory monitor)
app="MunkiReport"                                                                              # The actual name of our App once installed
logandmetadir="/Library/Logs/Microsoft/IntuneScripts/installMunkiReport"                           # The location of our logs and last updated data
processpath="/Library/Preferences/MunkiReport.plist"                                    # The process name of the App we are installing
