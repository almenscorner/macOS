...
############################################################################################
##
## Script to download Munki for macOS
##
###########################################
...
## adapted script from Neil to install Munki - Managed software installation for OS X (https://www.munki.org/munki/)
## install script will add additional middleware python script to allow usage of Azure blob storage (https://github.com/okieselbach/Munki-Middleware-Azure-Storage)
## by Oliver Kieselbach (@okieselb), oliverkieselbach.com

## modified script to run Munki managessoftareupdate --manualcheck and --installonly to make sure managed installs are installed as soon as possible
## extra function added, (waitForProfile) to make sure Munki configurations are in place before managedsoftwareupdate runs
## by almenscorner

# Define variables
weburl=""      			# What is the Azure Blob Storage URL?
weburl_middleware=""
appname=""                                                             # The name of our App deployment script
app="Managed Software Center.app"                                                               # The actual name of our App once installed
logandmetadir="/Library/Logs/Microsoft/IntuneScripts/installMunki"                              # The location of our logs and last updated data
processpath="/Applications/Managed Software Center.app/Contents/MacOS/Managed Software Center"  # The process name of the App we are installing
...
munkiProfileName="Munki"                                                                        # Name of Munki profile in Intune
...
# Wait for Munki Profile to be determined
waitForCondition
